...
// connect to db
$link = mysqli_connect($db_host, $db_user, $db_pass,$db_name) or die(mysql_error());
...
// get marker totals
$total_approved = mysqli_num_rows(mysqli_query($link,"SELECT id FROM places WHERE approved='1'"));
$total_rejected = mysqli_num_rows(mysqli_query($link,"SELECT id FROM places WHERE approved='0'"));
$total_pending = mysqli_num_rows(mysqli_query($link,"SELECT id FROM places WHERE approved IS null")) + mysqli_num_rows(mysqli_query($link,"SELECT id FROM events WHERE approved IS null"));
$total_all = mysqli_num_rows(mysqli_query($link,"SELECT id FROM places"));
